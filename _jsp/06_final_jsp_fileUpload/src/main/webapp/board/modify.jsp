					...
					<form action="/brd/update" method="post" enctype="multipart/form-data">
					   <input type="hidden" value="${bvo.bno }" name="bno">
						...
						<div class="mb-4 form-floating">
                            ...
                            <input type="hidden" class="form-control" id="file" name="image_file"
                             value="${bvo.image_file }">
			            <div class="mb-4 form-floating">
                            <input type="file" class="form-control" id="new_file" name="new_file"
                                accept="image/pno, image/jpeg, image/jpg, image/gif" value="${bvo.image_file }"> <label for="new_file">Image File</label>
                        </div>
