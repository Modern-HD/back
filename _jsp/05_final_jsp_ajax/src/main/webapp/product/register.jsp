		...
		<div class="row">
			<div class="col-xl-6 offset-xl-3">
				<div class="text-box mt-5 mb-5">
					<p class="mb-4">
						 <a class="blue" href="#">Product Register</a>
					</p>

					<!-- Sign Up Form -->
					<form action="/pdt/insert" method="post">
					   <div class="mb-4 form-floating">
			              <input type="text" class="form-control" id="" name="pname"
			                placeholder="Board title"> <label for="">Product Name</label>
			            </div>
			            <div class="mb-4 form-floating">
			              <input type="text" class="form-control" id="" name="price"
			                placeholder="Board Price"> <label for="">Product
			                Price</label>
			            </div>
			            <div class="mb-4 form-floating">
