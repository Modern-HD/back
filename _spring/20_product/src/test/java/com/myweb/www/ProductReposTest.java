...
public class ProductReposTest {
	...
	public void insertProductTest() throws Exception {
		int isUp = pdao.insert(new ProductVO("TestUsers", 1234, "testerUser", "This is Test Product", "testerUsers"));
	...
	public void insertDummyProduct() throws Exception {
		for (int i = 1; i <= 50; i++) {
			int isUp = pdao.insert(new ProductVO("testProduct" + i, i * 100, "testers" + i, "This is Test Product", "testers" + i));
