...
public class MemberController {
	...
	public String register(MemberVO mvo, @RequestParam(name = "file", required = false) MultipartFile[] file) {
		log.info(">>> regiser-mvo : {}", mvo);
		int isUp = msv.register(mvo, file != null ? fhd.getFileList(file).get(0) : null);
