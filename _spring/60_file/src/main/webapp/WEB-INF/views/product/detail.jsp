...
<div class="container mt-3">
        ...
        <c:forEach items="${pdto.fileList }" var="fvo">
            <c:choose>
                ...
                <div class="p-2 flex-fill bg-info">
                    <img class="th-img" src="/upload/${fn:replace(fvo.saveDir, '\\','/')}/${fvo.uuid}_th_${fvo.fileName}">
                </div>
                </c:when>
    ...
    <div class="mb-3 col-12 p-4 mx-auto shadow" style="height: 180px;">
        <div class="float-start" style="width: 130px; margin-right: 20px;">
            <c:if test="${pdto.profile eq null }">
            <img class="rounded-circle" src="/resources/images/profile_icon.png" style="width: 130px; height: 130px; object-fit: cover;">
            </c:if>
            <c:if test="${pdto.profile ne null }">
            <img class="rounded-circle" src="/upload/${fn:replace(pdto.profile.saveDir, '\\','/')}/${pdto.profile.uuid}_th_${pdto.profile.fileName}" style="width: 130px; height: 130px; object-fit: cover;">
            </c:if>
        </div>
        <div class="float-start col-8" style="height: 65px">
            <h3><c:out value="${pvo.writer}"/></h3>
        </div>
        <div class="float-start col-8" style="height: 65px">
            자기소개를 입력해주세요.
        </div>
...
<div id="img_modal" class="position-fixed top-50 start-50 translate-middle d-none" style="box-shadow: 0 0 0 9999px rgba(51, 51, 51, 0.5);">
    <img id="row_img" src="">
</div>
